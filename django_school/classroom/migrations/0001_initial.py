# Generated by Django 3.0 on 2020-05-04 07:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adresse_email', models.EmailField(max_length=100, verbose_name='email address ')),
                ('numero_telephone', models.IntegerField(blank=True, null=True, verbose_name='Phone number  ')),
                ('composante', models.CharField(max_length=100, verbose_name='Institution  ')),
                ...
                ('choice_field', models.CharField(blank=True, max_length=270, null=True, verbose_name='City  ')),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('name_adre', models.CharField(blank=True, max_length=270, null=True, verbose_name='Last name  ')),
                ('prenom_adre', models.CharField(blank=True, max_length=270, null=True, verbose_name='First name   ')),
                ('adresse_email_adre', models.EmailField(blank=True, max_length=100, null=True, verbose_name='email address ')),
